...
var loanOfficer = new Schema({
    ...
    nmlsId: {type: Number, required: true},

    clients: [client],
    userType: {type: String, required: true, default: 'loanOfficer'},
    ...
    companyPhone: {type: String, required: true}, //removed default
    companyFax: {type: String, required: true}, //removed default
    brokerCompany: {type: String, required: true}, //removed default
    companyAddress: {
      number: {type: Number}, //removed default
      street: {type: String}, //removed default
      zip: {type: String}, //removed default
      state : {type: String}, //removed default
      suite: {type: String} //removed default
    },
    ...
    leaderId: {type: Schema.Types.ObjectId, default: null, ref: 'loanOfficer'},
    closed :[{
